...
<?php
$sql = "SELECT a.AnnouncementID, a.Title, a.Description, a.PhotoURL, a.Location, a.ContactPhone,
               u.Username, c.Age, c.Gender, c.Vaccinated, c.Neutered
        FROM Announcement a
...
if ($result && $result->num_rows > 0) {
  while ($row = $result->fetch_assoc()) {
    ...
    <a href="view-announcement.php?id='.$row['AnnouncementID'].'"
      ...
      <div class="cat-card">
        ...
        <div class="cat-title">'.htmlspecialchars($row['Title']).'</div>
  ...
  echo '<section class="empty-state">
          <div class="empty-content">
            ...
            <p>There are currently no cats available for adoption.</p>
            <button class="cta-button" onclick="location.href=\'add.php\'">
              Post an Adoption Announcement
            </button>
          </div>
        </section>';
}
...
<footer>
  <div class="footer-content">Paws Connect 2025 ©</div>
</footer>
